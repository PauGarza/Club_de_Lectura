<%@ Page Theme="GenericoAdmin" Title="" Language="C#" MasterPageFile="~/CRUDSalasAdmin.Master" AutoEventWireup="true" CodeBehind="CRUDSalasAdmin.aspx.cs" Inherits="Club_de_Lectura.CRUDSalasAdmin1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cont" runat="server">
    <p style="margin-left: 40px">
        ...
        <br />
        <asp:Button ID="Button7" runat="server" Text="Nueva Sala" OnClick="Button7_Click" />
        <br />
        <br />
        Nombre:
        <br />
